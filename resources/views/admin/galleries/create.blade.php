                    ...
                    <form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @error('image')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <img id="preview" class="mt-2 hidden w-32 h-32 object-cover rounded">
                        </div>
                        ...
                        <div class="flex justify-end">
                            ...
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Create Gallery</button>
                        </div>
                    </form>
                </div>
            </div>
